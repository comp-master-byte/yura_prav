  ...
  return (
    <div className={styles.signupPage}>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className={styles.checkboxText}>
          <div className={styles.checkboxContent}>
            <input type="checkbox" id="logCheck" {...register("is_lawer")} />
            <label htmlFor="logCheck" className={styles.text}>
              Вы являетесь юристом?
            </label>
          </div>
        </div>
        ...
        <div
          className={classNames(styles.genderText, {
            [styles.checkboxError]:
              !selectGender && Object.keys(errors).length > 0,
          })}
        >
          ...
          <div className={styles.genderContent}>
            <div className={styles.checkboxContent}>
              ...
              />
              <label htmlFor="male" className={styles.text}>
                Мужчина
              </label>
            </div>
            <div className={styles.checkboxContent}>
              ...
              />
              <label htmlFor="female" className={styles.text}>
                Женщина
              </label>
            </div>
          </div>
        ...
        >
          <button disabled={Object.keys(errors).length > 0 || store.isLoading}>
            {store.registerBtnText}
          </button>
        </div>
      </form>
      ...
      <div className={styles.loginSignup}>
        ...
        <Link to="/" className={`${styles.text} ${styles.signupText}`}>
          Войдите сейчас
        </Link>
      </div>
    </div>
