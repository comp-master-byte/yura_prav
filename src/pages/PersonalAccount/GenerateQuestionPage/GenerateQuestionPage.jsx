    ...
    <>
      <div className={styles.generateQuestionWrapper}>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          />
          <div
            className={classNames(styles.genderText, {
              [styles.withoutMarginBottom]:
                answersList.length > 0 && selectQuestionOrAnswer === "q",
            })}
          >
            <div className={styles.genderTitle}>
              К какой категории относится ваше сообщение
            </div>
            <div className={styles.genderContent}>
              <div className={styles.checkboxContent}>
                <input
                  ...
                  checked={
                    selectQuestionOrAnswer === "a" || !selectQuestionOrAnswer
                      ? false
                      : true
                  }
                />
                <label htmlFor="question" className={styles.text}>
                  Вопрос
                </label>
              </div>
              <div className={styles.checkboxContent}>
                <input
                  ...
                  checked={
                    selectQuestionOrAnswer === "q" || !selectQuestionOrAnswer
                      ? false
                      : true
                  }
                />
                <label htmlFor="answer" className={styles.text}>
                  Ответ
                </label>
              </div>
            </div>
          ...
          {selectQuestionOrAnswer === "q" && (
            <div className={styles.generateAnswerList}>
              {answersList?.map((item) => (
                <UIInput
                  ...
                  togglePasswordVisibility={(e) =>
                    deleteSelectedAnswer(e, item.id)
                  }
              ...
              <UIButton
                customClassName={styles.generateAnswerList__btn}
                onClick={(e) => addAnswerToTheList(e)}
              >
                Добавить ответ
              </UIButton>
            </div>
